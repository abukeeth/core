...
/**
 * The original 7-step Business Setup Wizard. Preserved unchanged and used
 * whenever the Onboarding V3 flag is off, so the proven flow (and everyone
 * mid-onboarding on it) keeps working exactly as before.
 */
