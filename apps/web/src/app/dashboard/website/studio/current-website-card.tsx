  ...
  return (
    <Card>
      ...
      {isLive ? (
        ...
        <p className="mt-5 rounded-2xl border border-[#E7DDCF] bg-[#FBF7F1] px-4 py-3 text-sm text-[#756B5D]">
          Publish your website to get your live link, QR code, and share options.
        </p>
      )}
    </Card>
  );
